      ...
      <div className={styles.aboutMe__wrapper}>
        ...
        <div className={styles.aboutMe__subtitleWrapper}>
          <p className={styles.aboutMe__subtitle}>
            Привет! Я — фронтенд-разработчик с опытом работы на Vue.js. Создавал
            телеграм-ботов на Node.js, знаком с PWA и инструментами тестирования
            Cypress и Jest. Использую Vite для сборки проектов. Стремлюсь к
            созданию современных и эффективных веб-приложений.
          </p>
          <p className={styles.aboutMe__subtitle}>
